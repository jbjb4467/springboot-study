package site.jbjb.webservice.springboot.web.domain.posts;
...
public class PostsRepositoryTest {
    ...
    public void register_BaseTimeEntity() {
        //given
        LocalDateTime now = LocalDateTime.of(2021,10,23,18,0,0);
        postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
                .author("author")
